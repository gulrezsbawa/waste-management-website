  ...
  return (
    <section className="about-us py-5">
      <div className="container text-center bg-light">
        ...
        <p>At [Your Business Name], our mission is to make recycling accessible and effective. We aim to educate our community about the importance of recycling and provide a seamless process for individuals and businesses alike.</p>
